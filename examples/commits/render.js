...
function anonymous() {
  with (this) {
    return _c(
      ...
      { attrs: { id: 'demo' } },
      [
        _c('h1', [_v('Latest Vue.js Commits')]),
        _v(' '),
        _l(branches, function(branch) {
          return [
            _c('input', {
              directives: [
                {
            ...
            _v(' '),
            _c('label', { attrs: { for: branch } }, [_v(_s(branch))])
          ];
        }),
        _v(' '),
        _c('p', [_v('vuejs/vue@' + _s(currentBranch))]),
        _v(' '),
        _c(
          'ul',
          _l(commits, function(record) {
            return _c('li', [
              _c(
                'a',
                {
